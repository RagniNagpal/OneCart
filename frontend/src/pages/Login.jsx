...
function Login() {
  ...
  return (
    <div className='w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-white flex flex-col'>
      ...
      {/* Title */}
      <div className='h-[100px] flex flex-col items-center justify-center gap-[10px]'>
        <span className='text-[25px] font-semibold'>Login Page</span>
        <span className='text-[16px]'>Welcome back to OneCart</span>
      </div>

      {/* Card */}
      <div className='max-w-[600px] w-[90%] h-[450px] mx-auto bg-[#00000025] border border-[#96969635] backdrop-blur-2xl rounded-lg shadow-lg flex items-center justify-center'>

        <form onSubmit={handleLogin} className='w-[90%] h-[90%] flex flex-col gap-[20px]'>

          {/* Google Login */}
          <div
            onClick={googleLogin}
            className='w-full h-[50px] bg-[#42656cae] rounded-lg flex items-center justify-center gap-[15px] cursor-pointer'>
            <img src={google} alt="google" className='w-[20px]' />
            Login with Google
          </div>
          ...
          <div className='flex flex-col gap-[15px] relative'>
            <input
              ...
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              className='w-full h-[50px] border-2 border-[#96969635] rounded-lg bg-transparent px-[20px]'
            />
            ...
            {show ? (
              <IoEye onClick={() => setShow(false)} className="absolute right-[5%] top-[58%] cursor-pointer" />
            ) : (
              <IoEyeOutline onClick={() => setShow(true)} className="absolute right-[5%] top-[58%] cursor-pointer" />
            )}

            <button className='w-full h-[50px] bg-[#6060f5] rounded-lg text-[17px] font-semibold'>
              Login
            </button>
